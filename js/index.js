...
function getPresenter() {
  ...
  const allSpeakersCont = document.createElement('div');
  allSpeakersCont.classList.add('speakers-container');
  heading.classList.add('heading');
  heading.innerHTML = '<h2>Featured Speakers</h2>';
  ...
  speakersData.forEach((data) => {
    ...
    allSpeakersCont.appendChild(presenterCard);
    presentersContainer.appendChild(allSpeakersCont);
  });
}
